import { MigodiConfig } from './client.js';
...
export declare class Migodi {
     ...
     * ```
     */
    constructor(apiKey: string, config?: Partial<MigodiConfig>);
}
